    ...
    <div className="flex flex-col items-center justify-center min-h-full w-full px-4">
          ...
          {interviewStage === 'interview' ? (
            ...
            <Card className="w-full" variant="glassmorphic">
              ...
              <div className="p-3 rounded-lg bg-gray-800/70 border-l-2 border-blue-500 mb-4">
                <p className="text-sm font-medium mb-2 text-gray-400">Interviewer</p>
                <p className="text-gray-300">Example questions will appear here during the interview.</p>
              </div>
              {interviewStage === 'form' && (
      ...
      {interviewStage === 'summarizing' && (
        <div className="absolute inset-0 flex items-center justify-center bg-gray-900/80 backdrop-blur-sm z-10">
          <div className={`stage-transition ${animationState === 'transition-out' ? 'stage-enter' : 'stage-active'}`}>
            <Card className="w-full max-w-md mx-auto text-center py-8" variant="glassmorphic">
              <div className="flex flex-col items-center">
                <div className="relative mb-6">
                  <FaSpinner className="animate-spin text-blue-500 text-4xl" />
                  <div className="absolute inset-0 rounded-full bg-blue-500/10 blur-xl"></div>
                </div>
                <h2 className="text-xl font-semibold mb-3 text-white">Analyzing Interview</h2>
                <p className="text-gray-400 max-w-sm mx-auto">
                  Please wait while we generate a comprehensive summary of your interview responses...
                </p>
              </div>
            </Card>
          </div>
          ...
          <div className={`stage-transition ${animationState === 'transition-out' ? 'stage-enter' : 'stage-active'}`}>
            <Card className="w-full max-w-xl mx-auto" variant="glassmorphic">
              <div className="flex items-center mb-5 pb-3 border-b border-gray-800">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-white">Interview Completed</h2>
              ...
              <div className="mb-6">
                <h3 className="text-gray-300 text-lg mb-3 font-medium">Interview Summary</h3>
